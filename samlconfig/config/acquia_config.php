...
$config['technicalcontact_name'] = "UCLA API Support";
$config['technicalcontact_email'] = "api-support@it.ucla.edu";

// Change these for your installation.
$config['secretsalt'] = 'UCLAspicyflower';
$config['auth.adminpassword'] = 'qu!ckShape53';
